...
public class SearchSuggestionProvider extends ContentProvider {
    ...
    private Cursor getSuggestions(String query, String[] projection) {
        ...
        List<String> matchedFriends = FacebookData.getInstance().getMatches(processedQuery);
    ...
    private Object[] columnValuesOfWord(long id, String friend) {
        return new Object[] {
                id,					// _id
                friend,				// text1
                friend,				// intent_data (included when clicking on item)
        };
    }
