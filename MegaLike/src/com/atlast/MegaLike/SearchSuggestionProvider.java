...
public class SearchSuggestionProvider extends ContentProvider {
	...
	public static String AUTHORITY = "com.atlast.MegaLike.SearchSuggestionProvider";
	...
	private Cursor getSuggestions(String query, String[] projection) {
		...
		long id = 0;
		for (FQLFriend friend : matchedFriends) {
			cursor.addRow(columnValuesOfWord(id++, friend));
		}

		return cursor;
	}

	private Object[] columnValuesOfWord(long id, FQLFriend friend) {
		return new Object[] { 
				id, 			// _id
				friend.name, 	// name of a friend
				friend.uid,		// UID of a friend = intent_data (included when clicking on item)
		};
	}
